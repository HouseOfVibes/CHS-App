          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-chs-deep-navy">
                  Filters
                </h2>
              </div>
              <button
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-chs-teal-green focus:border-chs-teal-green transition-all"
                />
              </div>
          ...
          {!isLoading && !error && filteredHomes.length > 0 && (
            <div className="space-y-6">
              {filteredHomes.map((home) => (
                <div
                  key={home.id}
                  className="bg-gradient-to-r from-white to-gray-50 rounded-2xl shadow-lg p-6 md:p-8 hover:shadow-2xl transition-all border-2 border-transparent hover:border-chs-teal-green/30"
                >
